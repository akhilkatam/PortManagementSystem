...
/**
 * Servlet implementation class TrabsLogin
 */
@WebServlet("/TrabsLogin")
public class TrabsLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs=stmt.executeQuery("select password from logintrans where username='"+username+"'");
			rs.next();

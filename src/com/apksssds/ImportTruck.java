...
/**
 * Servlet implementation class ImportTruck
 */
@WebServlet("/ImportTruck")
public class ImportTruck extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    stmt.executeUpdate("update container set withdrawal_date=current_timestamp where container_id="+cid+" and container_state='import' ");

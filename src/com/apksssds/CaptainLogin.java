...
/**
 * Servlet implementation class CaptainLogin
 */
@WebServlet("/CaptainLogin")
public class CaptainLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs=stmt.executeQuery("select password from captain_login where username='"+username+"'");
			rs.next();

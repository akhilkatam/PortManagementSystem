...
/**
 * Servlet implementation class ContainerOwnerLogin
 */
@WebServlet("/ContainerOwnerLogin")
public class ContainerOwnerLogin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ContainerOwnerLogin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ResultSet rs=stmt.executeQuery("select password from container_login where username='"+username+"'");
			rs.next();
